  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-slate-300 font-sans selection:bg-purple-500/30">
      <div className="max-w-5xl mx-auto p-4 md:p-6 lg:p-8 flex flex-col min-h-screen gap-6 md:gap-10">
        ...
        {/* Header */}
        <header className="border-b border-white/5 pb-4 md:pb-6 text-center relative">
            ...
            {/* GitHub Link (Absolute Positioned for Desktop, Centered for Mobile) */}
            <a 
                href="https://github.com/cnlgks1/Auth-Logic-Playground" 
                target="_blank" 
                rel="noreferrer"
